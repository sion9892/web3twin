...
contract Web3TwinNFT is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    {
        // Always return the API endpoint URL, ignoring any stored tokenURI
        // This ensures Basescan and other explorers can fetch metadata correctly
        // The metadata is dynamically generated by the API endpoint using getTwinMatch
